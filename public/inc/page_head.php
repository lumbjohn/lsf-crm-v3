...
<div id="page-wrapper"<?php if ($template['page_preloader']) { echo ' class="page-loading"'; } ?>>
    ...
    <div class="preloader themed-background">
        <h1 class="push-top-bottom text-light text-center"><strong>LSF</strong> Energie</h1>
        <div class="inner">
        ...
        <div id="sidebar-alt">
            ...
            <div id="sidebar-alt-scroll">
                ...
                <div class="sidebar-content">
					<a class="sidebar-title" href="javascript:void(0);">
						<i class="fa fa-envelope pull-right"></i> <strong>Rappel Urgent</strong>
					</a>
					<?php
						/*$messages = Message::getUnreadAlerteAdmin();
						...
						<?php
							...
							?>
								<div class="sidebar-section">
									<div class="alert alert-alt">
										<a href="driver.php?id_driver=<?php echo $message['id_driver']; ?>"><?php echo $message['first_name_driver'].' '.$message['last_name_driver']; ?></a>
										<small class="pull-right"><?php echo date('d/m/Y H:i', strtotime($message['date_create'])); ?></small>
										<br>
										<?php echo $message['tel']; ?>
										<br>
										<a class="btn btn-xs btn-primary btmsgread" href="javascript:void(0)" data-id="<?php echo $message['id_message']; ?>"><i class="fa fa-check"></i> Traité</a>
									</div>
								</div>								
							<?php
							}
							...
							echo '<div class="sidebar-section">Aucune demande de rappel</div>';
						*/
					?>
                </div>
                <!-- END Sidebar Content -->
            ...
            <div id="sidebar-scroll">
                ...
                <div class="sidebar-content">
                    ...
                    <a href="index.php" class="sidebar-brand">
                        <i class="gi gi-flash"></i><span class="sidebar-nav-mini-hide"><strong>LSF</strong> Energie</span>
                    </a>
                    <!-- END Brand -->
                    ...
                    <div class="sidebar-section sidebar-user clearfix sidebar-nav-mini-hide">
                        ...
                        <div class="sidebar-user-name"><?php echo $currentUser->user_name; ?></div>
                        <div class="sidebar-user-links">
                            <a href="#" data-toggle="tooltip" data-placement="bottom" title="Profile" onclick="showCrmUser(<?php echo $currentUser->id_crmuser; ?>);"><i class="gi gi-user"></i></a>
                            ...
                            <?php if (CrmUser::isAdmin($currentUser)) { ?>
								<a href="settings.php" class="enable-tooltip" data-placement="bottom" title="Settings"><i class="gi gi-cogwheel"></i></a>
							<?php } ?>
							<a href="login.php?logoff=1" data-toggle="tooltip" data-placement="bottom" title="Logout"><i class="gi gi-exit"></i></a>
                        </div>
                    </div>
                    <!-- END User Info -->
                    ...
                    <ul class="nav navbar-nav-custom pull-right visible-xs">
                        ...
                        <li>
                            <a href="javascript:void(0)" onclick="App.sidebar('toggle-sidebar-alt');">
                                <i class="gi gi-phone_alt"></i>
                                <span class="label label-primary label-indicator animation-floating"><?php echo $messages && $messages->num_rows > 0 ? $messages->num_rows : ''; ?></span>
                            </a>
                        </li>
                    </ul>
                ...
                <ul class="nav navbar-nav-custom pull-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
                            ...
                            <li>
                                <a href="#" onclick="showCrmUser(<?php echo $currentUser->id_crmuser; ?>);">
                            ...
                            <li class="divider"></li>
                            <li>
                                <a href="login.php?logoff=1"><i class="fa fa-ban fa-fw pull-right"></i> Logout</a>
                            </li>                            
                        </ul>
                    </li>
                    <!-- END User Dropdown -->
